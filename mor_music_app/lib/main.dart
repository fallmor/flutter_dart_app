...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new MyHomePage(title: 'Bolt Music'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Musique> maListeDeMusiques = [
    new Musique('Mamusique1', 'Mor', 'images/musique2.jpeg', 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3'),
    new Musique('Mamusique2', 'astou', 'images/musique2.jpeg', 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3'),
